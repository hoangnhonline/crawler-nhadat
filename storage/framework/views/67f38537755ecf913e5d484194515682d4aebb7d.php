        ...
        <div class="form-group">
            ...
            <select class="form-control" name="role" id="role">      
              <option value="" >--Tất cả--</option>
                <option value="2" <?php echo e($role == 2 ? "selected" : ""); ?>>CSKH</option> 
                <option value="3" <?php echo e($role == 3 ? "selected" : ""); ?>>Sales</option>
                <option value="4" <?php echo e($role == 4 ? "selected" : ""); ?>>Marketing</option>
            </select>
          </div>          
          </form>
      </div>
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <?php foreach( $items as $item ): ?>
                ...
                <tr id="row-<?php echo e($item->id); ?>">
                  ...
                  <td><?php echo e(Helper::getRole($item->role)); ?></td>
